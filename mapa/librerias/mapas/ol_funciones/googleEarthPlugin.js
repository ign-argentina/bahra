...
http://code.google.com/p/earth-api-samples/issues/detail?id=141
*/
...
mapfish.earth = OpenLayers.Class({
    ...
    initialize: function (map, earthDiv, options) {
        ...
        this.features = [
            ...
            new OpenLayers.Feature.Vector(null, {role: 'lookAt'}, {pointRadius: 8,
                                                                   fillColor: '#ff0000'}),
            new OpenLayers.Feature.Vector(null, {role: 'camera'}, {externalGraphic: '/mapserver/librerias/images/eye.png',
                                                                      graphicHeight: 18,
                                                                      graphicWidth: 31,
                                                                      graphicYOffset: -3,
                                                                      rotation: 0})];
    ...
    failureGE: function(object) {
        alert("Fallo la carga de Google Earth.\nSi no dispone del plugin debe descargarlo de: http://code.google.com/apis/earth/");
    },
    ...
    initEarth: function(earthDiv) {
        var self = this;
        //displayNoneWorkaround(earthDiv); // Esto hace que no cargue en Firefox. Cosa de mandinga.
