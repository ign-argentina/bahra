...
*/
// Nueva función _updateMetric
    _updateMetric: function (t) {
        var e = this._getRoundNum(t), i, n, o, s, a,
                r = this._iScaleFirstNumber,
                h = this._iScaleSecondNumber,
                l = this._iScale,
                u = this._iScaleLabel;
                
            u.innerHTML = "0", 1e3 > e ? (i = this._getRoundNum(e), o = this._getRoundNum(e / 2), l.style.width = this._getScaleWidth(e / t) + "px", r.innerHTML = o, h.innerHTML = i + "m") : (a=e/1e3, n = this._getRoundNum(a), s = this._getRoundNum(a / 2), l.style.width = this._getScaleWidth(n / a) + "px", r.innerHTML = s, h.innerHTML = n + "km")
        },
